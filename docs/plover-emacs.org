...
steno theoretical challenge: how can modified letters (including
combinations of modifiers) memorably coexist alongside established
natural language steno definitions?
...
yields a [[mode_prefix][mode prefix]].  The principles of [[http://www.openstenoproject.org/stenodict/dictionaries/cross_platform_movement.html][Cross Platform Movement]] which
apply for Left, Up, Down, Right, Page Up/Page Down, and Home/End
extend to the entire alphabet.
...
Alt.]]  The keys used for [[shift][Shift]] and [[alt][Alt]] are the same as for [[alt-shift][Alt + Shift]].
And so on.
