...
apply.  Super is included for completeness.
...
comprehensive modifier coverage within Plover theory.  Detailed
description of each modifier combination are given below.

** Control <<control>>
# todo convert paragraphs to tables, like with the Alt section
| L Pattern     | Left hand | Modifier | Right Hand | R Pattern      |
|---------------+-----------+----------+------------+----------------|
| [[./img/kpw.png]] | =KPW=     | Control  | =-PBG=     | [[./img/-pbg.png]] |
...
for ={^ing}= in some single-stroke words (=TK-PBG= for "defining";
=TP-PBG= for "financing"; =TKPW-PBG= for "gunning"; =K-PBG= for
"conditioning"; =HR-PBG= for "listening"; =PH-PBG= for "machining";
=R-PBG= for "reasoning"; =S-PBG= for "seasoning"; =T-PBG= for
"continuing"; =W-PBG= for "winning"; and =KP-PBG= for "examining").
...
"examining").  This is easy to remember, so hopefully it's a fair
compromise.
